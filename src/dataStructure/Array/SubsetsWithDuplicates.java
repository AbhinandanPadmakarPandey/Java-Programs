 ...
 * if we follow the same approach discussed in Subsets, we will end up with duplicate subsets, which is not acceptable.
 ...
 *     [[], [1], [3], [1,3], [3,3], [1,3,3]]
 *
 *     - Finally, add the forth number (5) to all the existing subsets: [[], [1], [3], [1,3], [3,3],
