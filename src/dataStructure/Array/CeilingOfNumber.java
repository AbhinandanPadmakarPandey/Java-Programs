 ...
 * in a sorted array efficiently, we can use a modified version of the Binary Search to find the ceiling of a number.
 *
 * We can use a similar approach as discussed in Order-agnostic Binary Search. We will try to search for
 * the ‘key’ in the given array. If we find the ‘key’, we return its index as the ceiling.
...
public class CeilingOfNumber {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                searchCeilingOfANumber(new int[] { 4, 6, 10 }, -1));
    }
}